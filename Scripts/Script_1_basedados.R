...
# baseampla_red <- subset(baseampla, select = c("code_muni", "cidade", "uf", "gasto_equip_defensivo", "raca", "escolaridade", "equip_defensiv", "idoso", "morte_cov", "idade", "contat_cov", "result_teste_1", "teste_cov", "pgt_plano","data_plano", "plano", "filho_dep", "estcivil", "d.escolaridade", "d.raca","raca", "sexo", "renda", "rendafam", "qtd_filho_dep","confirmed", "deaths", "confirmed_per_100k_inhabitants"))

# desisti de reduzir a base, mas optei por deixar o nome da base reduzida (baseampla_red)
baseampla_red <- baseampla
